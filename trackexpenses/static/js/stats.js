...
//   getChartData();
//   getChartDataIncome();
//   getChartDataIncomeAll();
//   getChartDataExpenseAll();
// });

// const renderChart = (data, labels, canvasId, chartTitle) => {
...
//           renderChart(data, label, "myChart", "Expenses by category");
//       });
// };
...
//           renderChart(data, label, "myChartIncome", "Income by source");
//       });
// };
...
//           renderChart(data, label, "myChartIncomeAll", "Overview of Income by Source");
//       });
// };

// const getChartDataExpenseAll = () => {
//   fetch("/expense_category_summary_all")
//       .then((res) => res.json())
//       .then((results) => {
//           console.log("results", results);
...
//           renderChart(data, label, "myChartExpenseAll", "Overview Expense by Category");
//       });
// };
